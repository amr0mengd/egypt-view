<template>
	...
	<div id="footer" class="mx-72 flex justify-around h-60">
		...
		<div id="links" class="flex py-8 justify-center space-x-28 text-xl">
			<div id="social links" class="space-y-7">
				...
				<ul class="space-y-3">
					<li class="hover:text-primary hover:underline active:text-white">
						<a target="_blank" href="https://www.facebook.com/Egypt.View.tourism/">{{ t("facebook") }}</a>
					</li>
					<li class="hover:text-primary hover:underline active:text-white">
						<a target="_blank" href="https://x.com/egypt_view">{{ t("twitter") }}</a>
					</li>
					<li class="hover:text-primary hover:underline active:text-white">
						<a target="_blank" href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=info@egypt-view.com">{{ t("mail") }}</a>
					</li>
				</ul>
			</div>
